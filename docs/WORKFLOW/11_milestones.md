...
*   **Functional Outcome:** The tangible, real-world state described in the [**Milestone Blueprint**](../milestones/milestone_blueprint.md) is achieved (e.g., "Users can successfully log in").
